...
add_action('generate_footer', 'gp_child_render_custom_footer');

function gp_child_render_custom_footer(): void
{
    if (function_exists('gp_child_cleanup_is_enabled') && gp_child_cleanup_is_enabled('remove_generatepress_footer')) {
        return;
    }
    ?>
